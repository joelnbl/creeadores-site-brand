...
import { CampaignFeatures } from "./components/campaign-features";
...
function LandingHeader() {
  ...
  return (
    <header
      className="sticky top-0 z-50 bg-[#0019DA] backdrop-blur-lg"
      style={{
        boxShadow:
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: "rgba(0, 25, 218, 0.08)" }}
                >
                ...
                <div>
                  ...
                  >
                    {nav.signUpDropdown.creator.label}
                  </p>
                  <p
                    className="text-gray-500"
                    style={{ fontSize: "12px", fontWeight: 400 }}
                  >
                    {nav.signUpDropdown.creator.description}
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p
                    ...
                    style={{ fontSize: "14px", fontWeight: 600 }}
                  >
                    {nav.signUpDropdown.brand.label}
                  </p>
                  <p
                    className="text-gray-500"
                    style={{ fontSize: "12px", fontWeight: 400 }}
                  >
                    {nav.signUpDropdown.brand.description}
                  </p>
                </div>
              </a>
            </div>
    ...
    >
      ...
      >
          ...
          <div className="flex flex-col items-center text-center">
            <div
              ...
              style={{
                ...
                border: "1px solid rgba(0, 25, 218, 0.25)",
                boxShadow:
                  "0 2px 20px rgba(0, 0, 0, 0.08), 0 1px 4px rgba(0, 0, 0, 0.04)",
              }}
            >
              <span
                className="flex items-center gap-1.5 uppercase text-[12px]"
                style={{
                  fontWeight: 700,
              ...
              <span
                ...
                style={{ backgroundColor: "rgba(0, 25, 218, 0.15)" }}
              />
              <div className="flex items-center gap-2.5">
                ...
                >
                  ...
                  <defs>
                    ...
                    <clipPath id="clip0_meta">
                      <rect width="70.7557" height="13.766" fill="white" />
                    </clipPath>
                  </defs>
                </svg>
              </div>
                ...
                textStyle={
                  {
                    fontWeight: 800,
                    background:
                      "linear-gradient(90deg, #0019DA 0%, #2201B2 35%, #ED4B00 100%)",
            ...
            <p
              className="text-gray-500 mb-4 sm:mb-8 max-w-lg text-[12px] sm:text-[14px]"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(0, 25, 218, 0.1), transparent)",
          }}
        />
      </section>
      {/* Campaign Types */}
